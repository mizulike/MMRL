...
Java_dev_dergoogler_mmrl_compat_impl_ksu_KsuNative_getAppProfile(JNIEnv *env, jobject, jstring pkg, jint uid) {
    ...
    auto cls = env->FindClass("dev/dergoogler/mmrl/compat/content/AppProfile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_dev_dergoogler_mmrl_compat_impl_ksu_KsuNative_setAppProfile(JNIEnv *env, jobject clazz, jobject profile) {
    auto cls = env->FindClass("dev/dergoogler/mmrl/compat/content/AppProfile");
